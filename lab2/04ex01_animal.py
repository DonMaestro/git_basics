...
if __name__ == '__main__':
    ...
    owner0 = Person("Bogdan", 24, 987654321)
    owner1 = Person("Vitalii", 21, 1234567890)

    pet = Pet(owner0, "duke")
    pet.add_vaccine("type0_4dog", datetime.datetime(2020,1,2), datetime.datetime(2024,1,2))
    pet.add_vaccine("type1_4dog", datetime.datetime(2021,2,5), datetime.datetime(2022,4,7))
    pets.append(pet)
    ...
    pet = Pet(owner1, "barsik")
    pet.add_vaccine("type0_4cat", datetime.datetime(2000,1,2), datetime.datetime(2024,1,2))
    pets.append(pet)
